...
enum ts_symbol_identifiers {
  ...
  aux_sym_use_names_list_repeat1 = 148,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [481] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use_names_list, 3, 0, 0),
  [483] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use_names_list, 2, 0, 0),
  ...
  [523] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use_names_list, 1, 0, 0),
  ...
  [625] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_use_names_list_repeat1, 2, 0, 0),
  [627] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_use_names_list_repeat1, 2, 0, 0), SHIFT_REPEAT(203),
