# Contributing to `tree-sitter-wit`

First of all, thank you very much for contributing to `tree-sitter-wit`.

The docs on creating tree-sitter grammars / parsers can be [found here](https://tree-sitter.github.io/tree-sitter/creating-parsers). If modifying the queries (.scm files), please ensure compliance with `[nvim-treesitters](https://github.com/nvim-treesitter/nvim-treesitter/blob/master/CONTRIBUTING.md) guidelines.
...
## Complying with nvim-treesitter standards

The below docs are heavily borrowed from [nvim-treesitter](https://github.com/nvim-treesitter/nvim-treesitter/blob/master/CONTRIBUTING.md).

As you may already know, `nvim-treesitter` is roughly split in two parts:
